...
class TestMethods(unittest.TestCase):
    ...
    def test_by_country_to_json(self):
        ...
        self.assertEqual(by_country_to_json('Italy', df), {"Country":
                                                           "Italy", "Year":
                                                           2017, "Value":
                                                           321481.224})
        self.assertEqual(by_country_to_json('Albania', df), {"Country":
                                                             "Albania", "Year":
                                                             2017, "Value":
                                                             4342.011})
    ...
    def test_mean_to_json(self):
        ...
        self.assertEqual(mean_to_json('1975', df), {"year": "1975", "total":
                                                    112083.79604545454})
        self.assertEqual(mean_to_json('2015', df), {"year": "2015", "total":
                                                    217617.02909154928})
